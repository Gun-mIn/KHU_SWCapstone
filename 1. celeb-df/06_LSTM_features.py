...
def main():
    ...
    seq_length=25
    load_weights_name="./trained_wts/EfficientNetB7_w_Celeb-DF_160_batch_10_v2.hdf5"
    image_size=160 #batch size
    ...
    for video in videos:
        ...
        if counter % 1000 == 0:
            ...
            np.save("./dataset_npy/lstm_CF_train_data_{}.npy".format(str(counter)), np.array(features))
            np.save("./dataset_npy/lstm_CF_train_label_{}.npy".format(str(counter)), np.array(labels))
    ...
    np.save("./dataset_npy/lstm_CF_train_data_{}.npy".format(str(counter)), features)
    np.save("./dataset_npy/lstm_CF_train_labels_{}.npy".format(str(counter)), labels)
...
# ------------------------------------------- Test Data -------------------------------------------------
    ...
    np.save("./dataset_npy/lstm_CF_test_data.npy", features)
    np.save("./dataset_npy/lstm_CF_test_labels.npy", labels)
