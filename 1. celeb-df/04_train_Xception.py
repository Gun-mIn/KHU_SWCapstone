...
def main():
    ...
    epochs=100
    weights_save_name="Xception_w_celeb_df"
    batch_size=16
    image_size=160

    # Training dataset loading
    train_data = np.load("./npy/train_data_celeb-df_25.npy")
    train_label = np.load("./npy/train_label_celeb-df_25.npy")
    ...
    csv_logger = CSVLogger(
        "training_logs/xception_celeb-df.log",
        separator=",",
        append=True,
    )
