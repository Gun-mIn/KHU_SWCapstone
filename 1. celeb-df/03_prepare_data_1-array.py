...
list_1 = sample(list_1, 5639)

vid_list = list_0 + list_1
shuffle(vid_list)

test_list = sample(vid_list, 518)
shuffle(test_list)
...
np.save("./dataset_npy/train_data_CF_fpv_" + str(frames_per_video) + "_rev_" + str(img_size), train_data)
np.save("./dataset_npy/train_label_CF_fpv_" + str(frames_per_video) + "_rev_" + str(img_size), train_label)
...
np.save("./dataset_npy/test_data_CF_fpv_" + str(frames_per_video) + "_rev_" + str(img_size), train_data)
np.save("./dataset_npy/test_label_CF_fpv_" + str(frames_per_video) + "_rev_" + str(img_size), train_label)
